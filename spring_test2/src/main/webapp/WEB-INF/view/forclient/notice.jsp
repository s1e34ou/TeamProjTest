...
<table width=570 border="0" cellpadding="0" cellspacing="0" id="boardlist">
    ...
    <tr align="center" valign="middle" bordercolor="#333333"
        ...
        <td height="23" style="font-family:Tahoma;font-size:12pt;" class="line">
            ...
            <td height="23" style="font-family:Tahoma;font-size:12pt;" class="line">
            <a style="color: black; text-decoration: none;" href="<%=request.getContextPath()%>/notice_view?boardNo=<%=pplist.get(i).getBoardNo()%>"><%=boardname%><%if(pplist.get(i).getReplyCount()>0){ %> (<%=pplist.get(i).getReplyCount()%>)<%}%></a>
